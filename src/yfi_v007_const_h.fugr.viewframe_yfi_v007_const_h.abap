*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YFI_V007_CONST_H
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YFI_V007_CONST_H    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YFI_V007_CONST_H'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YFI_V007_CONST_H_EXTRACT
TOTAL = YFI_V007_CONST_H_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YFI_V007_CONST_H'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YFI_V007_CONST_H-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YFI_V007_CONST_H_EXTRACT
TOTAL = YFI_V007_CONST_H_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YFI_V007_CONST_H-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YFI_V007_CONST_H'
...
TOTAL = YFI_V007_CONST_H_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YFI_V007_CONST_H-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YFI_V007_CONST_H-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_YFI_V007_CONST_H'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_YFI_V007_CONST_H-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YFI_V007_CONST_H_EXTRACT
TOTAL = YFI_V007_CONST_H_TOTAL
