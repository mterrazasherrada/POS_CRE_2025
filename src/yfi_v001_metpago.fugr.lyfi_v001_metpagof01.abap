...
FORM new_entry.
  ...
  yfi_v001_metpago-aedtm = sy-datlo. " Date
  yfi_v001_metpago-uzeit = sy-timlo. " Time
  yfi_v001_metpago-uname = sy-uname. " User
ENDFORM.
...
FORM before_save.
  ...
  TYPES: BEGIN OF lts_data.
           INCLUDE STRUCTURE yfi_v001_metpago. " Table Structure
