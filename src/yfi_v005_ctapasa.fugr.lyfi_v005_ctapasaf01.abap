...
FORM new_entry.
  ...
  yfi_v005_ctapasa-aedtm = sy-datlo. " Date
  yfi_v005_ctapasa-uzeit = sy-timlo. " Time
  yfi_v005_ctapasa-uname = sy-uname. " User
ENDFORM.
...
FORM before_save.
  ...
  TYPES: BEGIN OF lts_data.
           INCLUDE STRUCTURE yfi_v005_ctapasa. " Table Structure
