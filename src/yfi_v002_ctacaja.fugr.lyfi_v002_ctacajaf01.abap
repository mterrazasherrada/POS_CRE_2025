...
FORM new_entry.
  ...
  yfi_v002_ctacaja-aedtm = sy-datlo. " Date
  yfi_v002_ctacaja-uzeit = sy-timlo. " Time
  yfi_v002_ctacaja-uname = sy-uname. " User
ENDFORM.
...
FORM before_save.
  ...
  TYPES: BEGIN OF lts_data.
           INCLUDE STRUCTURE yfi_v002_ctacaja. " Table Structure
