...
FORM new_entry.
  ...
  yfi_v003_ctabcos-aedtm = sy-datlo. " Date
  yfi_v003_ctabcos-uzeit = sy-timlo. " Time
  yfi_v003_ctabcos-uname = sy-uname. " User
ENDFORM.
...
FORM before_save.
  ...
  TYPES: BEGIN OF lts_data.
           INCLUDE STRUCTURE yfi_v003_ctabcos. " Table Structure
