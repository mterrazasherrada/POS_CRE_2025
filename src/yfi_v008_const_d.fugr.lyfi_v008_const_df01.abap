*----------------------------------------------------------------------*
***INCLUDE LYFI_V008_CONST_DF01.
*----------------------------------------------------------------------*
FORM new_entry .
  yfi_v008_const_d-ernam = sy-uname . " User
  yfi_v008_const_d-erdat = sy-datlo . " Date
  yfi_v008_const_d-erzet = sy-timlo . " Time
ENDFORM .                    "new_entry
...
FORM before_save .
  ...
  TYPES: BEGIN OF lts_data .
           INCLUDE STRUCTURE yfi_v008_const_d . " Table Structure
